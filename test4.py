...
import requests,bs4,uuid,json,os,sys,random,time,datetime,re,subprocess
try:
    import rich
except ImportError:
    ...
    try:
        ...
        exit('[x] cannot install rich module,try manual(pip install rich)')
  
from rich.table import Table as me
from rich.console import Console as sol
from bs4 import BeautifulSoap as sop
from concurrent.futures import ThreadPoolExecuter as tred
...
my_color=[White,Red,Green,Yellow,Blue,Pink,N,O]
data,date2={},{}
aman,cp,salah=0,0,0
ubahP,ali,pwBaru=[],[],[]
ok=[]
...
headers_grp={"user-agent": "Mozilla/5.0 (Linux; Android 10; Mi 9T Pro Build/QKQ1.190825.002; wv) AppleWebKit/537.36 (KHTML, like Gecko) Version/4.0 Chrome/88.0.4324.181 Mobile Safari/537.36 [FBAN/EMA;FBLC/it_IT;FBAV/239.0.0.10.109;]"}
...
author=inocentaoun
Whatsapp=03477535379
keep ap the struggle
---------======-----=====--------===--------'''
def hasil(OK,cp):
	if not len(OK) != 0:
	    pass
